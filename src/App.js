...
import {spectrum_articles} from './data/spectrum_articles';
  ...
  return (
    <Router basename={process.env.PUBLIC_URL}>
      ...
      <Switch>
        ...
        <Route exact path='/uni-news' render={() => <Section id="uni-news" header="UNIVERSITY NEWS" articles={news_articles} next="Spectrum" link="/spectrum" key={0}/>} />
        <Route exact path='/spectrum' render={() => <Section id="spectrum" header="SPECTRUM" articles={spectrum_articles} next="Opinion" link="/opinion" key={1}/>} />
